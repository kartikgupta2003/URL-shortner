...
const urlRoute = require("./routes/routes_url.js");
const userRoute = require("./routes/routes_user.js");
const PORT =8001;
const {connectToMongoDB} = require("./connect.js");
const URL = require("./models/url.js");
connectToMongoDB("mongodb://localhost:27017/short-url");
// const {restrictToLoggedinUserOnly , checkAuth} = require("./middlewares/middleware_auth.js");
const {checkForAuthentication , restrictTo} = require("./middlewares/middleware_auth.js");

app.use(express.json());
app.use(express.urlencoded({extended :  false}));
// They're built-in middleware functions provided by Express, and their job is to parse the incoming request body and make it accessible via req.body.
// 🔍 In summary:
// express.json() → parses JSON payloads
// express.urlencoded() → parses form data (from <form> submissions

app.use(cookieParser());

app.use(checkForAuthentication);
//  It will run for every single incoming request, before any route is hit.
